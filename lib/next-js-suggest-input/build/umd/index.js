  ...
  var ReactTagInput = (function (_super) {
    ...
    function ReactTagInput() {
      ...
      _this.onBulr = function () {
        var input = _this.state.input;
        var _a = _this.props, validator = _a.validator; _a.removeOnBackspace;
        if (input === '') {
          return;
        }
        var valid = validator !== undefined ? validator(input) : true;
    ...
    ReactTagInput.prototype.render = function () {
      ...
      return (React__default['default'].createElement('div', { className: classSelectors.wrapper },
                                                      ...
                                                      showInput &&
                    React__default['default'].createElement('input', { ref: this.inputRef, value: input, className: classSelectors.input, placeholder: placeholder || 'Type and press enter', onChange: this.onInputChange, onBlurCapture: this.onBulr, onKeyDown: this.onInputKeyDown })));
    };
