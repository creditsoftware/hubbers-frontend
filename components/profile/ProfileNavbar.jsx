...
export const ProfileNavbar = ({ auth, actived = 'general' }) => {
  ...
  return <div>
    <Link href="/desk/profile/">
      <a style={{ display: 'inline-block' }} className={actived === 'general' ? 'p-3 active-profile' : 'p-3'}>General</a>
    </Link>
    <Link href="/desk/profile/creator-profile">
      <a style={{ display: 'inline-block' }} className={actived === 'creator' ? 'p-3 active-profile' : 'p-3'}>Creator</a>
    </Link>
